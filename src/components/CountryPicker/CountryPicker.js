    ...
    <div>
      <div className='row justify-content-between align-items-center p-3'>
        <div className='col-md-12 text-center'>
          <h1 className='mb-5'>Az ország adatai</h1>
        </div>
        ...
        <div className='my-3'>
          <div className='form-row'>
            <Select
              ...
              size={'large'}
              style={{ width: 200 }}
              placeholder='Válassz országok közül'
              optionFilterProp='children'
              filterOption={(input, option) =>
                option.children.toLowerCase().indexOf(input.toLowerCase()) >= 0
              }
            >
              <Option value='bangladesh'>Magyarország</Option>
        ...
        <div className='col-md-4 my-3'>
          <div className='row cases shadow align-items-center justify-content-between no-gutters'>
            ...
            <div className='col-8'>
              ...
              <p className='text-muted'>Fertőzött</p>
            </div>
          </div>
        </div>
        <div className='col-md-4 my-3'>
          <div className='row deaths shadow align-items-center justify-content-between no-gutters'>
            ...
            <div className='col-8'>
              ...
              <p className='text-muted'>Halálozás</p>
            </div>
          </div>
        </div>
        <div className='col-md-4 my-3'>
          <div className='row recovered shadow align-items-center justify-content-between no-gutters'>
            ...
            <div className='col-8'>
              ...
              <p className='text-muted'>Gyógyult</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='col-md-4 my-3'>
          <div className='row cases shadow align-items-center justify-content-between no-gutters'>
            ...
            <div className='col-8'>
              ...
              <p className='text-muted'>Új esetek</p>
            </div>
          </div>
        </div>
        <div className='col-md-4 my-3'>
          <div className='row deaths shadow align-items-center justify-content-between no-gutters'>
            ...
            <div className='col-8'>
              ...
              <p className='text-muted'>Halálozás ma</p>
            </div>
          </div>
        </div>
        <div className='col-md-4 my-3'>
          <div className='row critical shadow align-items-center justify-content-between no-gutters'>
            ...
            <div className='col-8'>
              ...
              <p className='text-muted'>Kritikus állapot</p>
            </div>
          </div>
        </div>
      </div>
